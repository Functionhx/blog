...
(function () {
  ...
  // 2) 卡片 3D 倾斜：随鼠标位置 rotateX/Y，离开复位
  function tilt() {
    var MAX = 6; // 最大度数
  ...
  // 3) 光标聚光灯：rAF 更新 --mx/--my，CSS 径向渐变跟随
  function spotlight() {
  ...
  ready(function () {
    [magnetic, tilt, spotlight].forEach(function (fn) {
